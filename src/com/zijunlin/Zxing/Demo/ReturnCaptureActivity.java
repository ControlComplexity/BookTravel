...
import com.zijunlin.Zxing.Demo.decoding.CaptureActivityHandler2;
import com.zijunlin.Zxing.Demo.decoding.InactivityTimer;
import com.zijunlin.Zxing.Demo.view.ViewfinderView;

public class ReturnCaptureActivity extends Activity implements Callback {
	...
	public void handleDecode(Result obj, Bitmap barcode) {
		...
		viewfinderView.drawResultBitmap(barcode);
		 ...
		 String neirong=obj.getText().toString();
		 Intent intent=new Intent(ReturnCaptureActivity.this, CaptureActivity1.class);
		 Bundle b = new Bundle();
