...
public class CaptureActivity1 extends CaptureActivity implements Callback{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //��ʼ�� CameraManager
        String tou="请在1分钟内扫描该书所在漂流点特有二维码";
        ...
        isbn=getIntent().getExtras().getCharSequence("text").toString();
        SharePreferenceUtil share = new SharePreferenceUtil(this, 
              Constants.SAVE_USER);
        tel = share.getTel();
    }
...
//              + obj.getText());
     ...
     HttpUtil.borrowbook(CaptureActivity1.this, tel, isbn, driftpointid);
            Log.i("CaptureActivity",driftpointid);
            Log.i("CaptureActivity",isbn);
            Log.i("CaptureActivity",tel);
         this.finish();       
    }
