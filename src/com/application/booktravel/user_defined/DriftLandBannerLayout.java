...
public class DriftLandBannerLayout extends ViewGroup {
...
//  private int mTouchSlop;
    ...
    public DriftLandBannerLayout(Context context) {
        super(context);
    ...
    public DriftLandBannerLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        // TODO Auto-generated constructor stub
        initView(context);
    }

    public DriftLandBannerLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
        // TODO Auto-generated constructor stub
    }
