...
public class IndexBannerLayout extends ViewGroup {
...
//  private int mTouchSlop;
    ...
    public IndexBannerLayout(Context context) {
        super(context);
    ...
    public IndexBannerLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        // TODO Auto-generated constructor stub
        initView(context);
    }

    public IndexBannerLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
        // TODO Auto-generated constructor stub
    }
