 ...
 * 
 */
public class CopyOfContactlistFragment extends Fragment {
	...
	class HXContactSyncListener implements HXSDKHelper.HXSyncListener {
		...
		public void onSyncSucess(final boolean success) {
			...
			CopyOfContactlistFragment.this.getActivity().runOnUiThread(new Runnable() {
				public void run() {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		return inflater.inflate(R.layout.copy_of_fragment_contact_list, container, false);
	}
